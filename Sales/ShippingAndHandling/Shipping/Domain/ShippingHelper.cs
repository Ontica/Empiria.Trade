...
namespace Empiria.Trade.Sales.ShippingAndHandling.Domain {
  ...
  internal class ShippingHelper {
    ...
    internal void GetShippingNumber(ShippingEntry shipping) {
      ...
      shipping.ShippingNumber = $"S-{shipping.ShippingOrderId.ToString().PadLeft(10, '0')}";
      shipping.DeliveryNumber = $"E-{shipping.ShippingOrderId.ToString().PadLeft(10, '0')}";
    }

...
namespace Empiria.Trade.Financial.Data {
  ...
  internal class MoneyAccountTransactionData {
    ...
    static internal void Write(MoneyAccountTransaction o) {
      ...
      var op = DataOperation.Parse("writeMoneyAccountTransactions", o.Id, o.UID, o.TransactionNumber, o.MoneyAccount.Id, o.TransactionType.Id, o.ReferenceTypeId, o.ReferenceId,

...
namespace ConnectionsToFirebirdSujetsa.Services {
  ...
  public class FbQueryStrings {
    ...
    public string productosNkConn = "SELECT PRODUCTO.PRODUCTO,PRODUCTO.CLAVEPRODSERV,PRODUCTO.DESCRIPCION, PRODUCTO.ALTA, PRODUCTO.LINEA, " +
      ...
      "COLOR.DESCRIPCION NACABADOS, PRODUCTO.COSTO_BASE, LISTA.PRECIO AS PMINIMO,INVENTARIO.EXISTENCIA, PRODUCTO.UNIDAD, PRODUCTO.MONEDA, " +
    ...
    public string productosNKHidroplomexConn =
      ...
      "PRODUCTO.SUBGRUPO, LARGO, COSTO_BASE, UNIDAD, PRODUCTO.MONEDA, PRECIO1, PRECIO2, PRECIO3, PRECIO4, EMPAQUE, MULTIPLO_RESURTIDO, " +
